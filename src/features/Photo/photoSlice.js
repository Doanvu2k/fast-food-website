...
const initialPhotos = [
    {
      id: 91176,
      category: 5,
      image: 'https://picsum.photos/id/532/300/300',
    ...
    },
    {
      id: 52685,
      category: 3,
      image: 'https://picsum.photos/id/859/300/300',
...
const photoSlice = createSlice({
    ...
    reducers: {
        ...
        updatePhoto: (state,action) => {
            ...
            const photoIndex = state.findIndex(p => p.id === newPhoto.id)
            if(photoIndex > -1)
            {
